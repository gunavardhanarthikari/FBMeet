...
export function Header({ roomId, isHost }: HeaderProps) {
  ...
  return (
    <header className="flex flex-wrap items-center justify-between gap-x-4 gap-y-2 border-b border-border-default px-4 py-3 sm:px-6 sm:py-4">
